...
public class PersonaMemoria implements Crudable<Persona> {
	...
	private PersonaMemoria() {
		//Desde aqui cargamos un archivo con todas las personas
		PersonaMemoria.CargarDatosInicio("C:\\Users\\curso\\Desktop\\bbdd.txt");
		
		//Si no queremos cargarlos desde ningun archivo se puede descomentar para que al iniciar tenga datos
